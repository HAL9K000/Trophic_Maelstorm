...
int main(int argc, char *argv[])
{
  ...
  double mGrazer; // Mass of grazer in kg.
  ...
  double k0, k1, k2; double d0, d1, d2, d3, d4; double s0, s1, s2; double v1, v2; double dtv1;
  ...
  double M[SpB] = {0, mj};     // Mortality Rate of Species. (in hr^{-1})
