...
int main()
{
  ...
  double a_start; double a_end; double b= -2; double c= 1; int div; double t_max;
  ...
  first_order_critical_exp_delta(Rho_0, div, t_max, a_start, a_end, b, c, D, sigma, dt, dx, r, g);
