...
#----------------------------------------------------------------------------
            ...
            CC='nvcc'
            CFLAGS='-gencode=arch=compute_20,code=sm_20 -gencode=arch=compute_20,code=compute_20 -gencode=arch=compute_10,code=compute_10 -gencode=arch=compute_13,code=compute_13 -O3 -Xcompiler "-fPIC -D_GNU_SOURCE -pthread -fexceptions -m32"'
...
#----------------------------------------------------------------------------
            RPATH="-Wl,-rpath-link,$TMW_ROOT/bin/$Arch"
            CC='nvcc'
            CFLAGS='-gencode=arch=compute_20,code=sm_20 -gencode=arch=compute_20,code=compute_20 -gencode=arch=compute_10,code=compute_10 -gencode=arch=compute_13,code=compute_13 -O3 -Xcompiler "-fPIC -D_GNU_SOURCE -pthread -fexceptions -m64"'
            CLIBS="$RPATH $MLIBS -lm -lstdc++"
            COPTIMFLAGS='-Xcompiler "-O3 -funroll-loops -msse2 -DNDEBUG"'
            CDEBUGFLAGS='-g'
#
