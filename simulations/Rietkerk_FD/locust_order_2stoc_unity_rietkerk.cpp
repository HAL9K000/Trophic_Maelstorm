...
int main(int argc, char *argv[])
{
    ...
    #ifndef LOCUST_WIND 
    string error_string = "ERROR: The LOCUST_WIND flag MUST be set globally, as g++ -DLOCUST_WIND locust_order_2stoc_unity_rietkerk.cpp ... \n";
  ...
  */
  ...
  cout << "This is a 2Sp (Two) Stochastic Rietkerk Model Script FOR LOCUSTS WITH UNIT INITIALISATION OF GRAZERS\n";
  ...
  if(argc == 1)
  {
    ...
    cout << "Enter wind speed range (w1, w2) in km/hr: ";
    cin >> w1 >> w2;
