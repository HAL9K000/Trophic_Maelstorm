...
int main(int argc, char *argv[])
{
  ...
  #ifndef LOCUST_WIND 
    string error_string = "ERROR: The LOCUST_WIND flag MUST be set globally, as g++ -DLOCUST_WIND locust_order_3stoc_burnin_rietkerk.cpp ... \n";
  ...
  d0 = 0.00025/24.0; d1 = 0.0009579; d2 = 0.00545856; d3 = 0.00025/24.0; d4= 0.025/24.0; s2 = 3; //From Bonachela et al 2015 (in km^2/hr) and general D allometry.
  ...
  //v1 = 0.000211125*0.001; //In km/hr [~ 10 km/hr average wind speed]
  //v2 = 1.515567*0.001; //In km/hr
  ...
  v2 = 0.25*pow(mPredator, 0.26)*(1.0 - exp(-20.0*pow(mPredator, -0.6))); //In km/hr [Equivalent to ~ 0.152 km/hr for 150g predator]
  ...
  dtv2 = 0.062272; //In hr, based on relation ln(dtv_predator) = 0.7*ln(M) + 0.6032, where M is mass in kg, and dtv_predator is in min.
  //*/
  ...
  */
  ...
  cout << "This is a 3Sp (Three) Stochastic Rietkerk Model Script FOR LOCUSTS  WITHOUT DDM AND UNIT INITIALISATION OF CONSUMERS\n";
  ...
  else if(argc == 15)
  {
    ...
    init_frac_pred = atof(argv[11]);
    aij_scale = atof(argv[12]);
    ajm_scale = atof(argv[13]);
    preFIX = argv[14];
  }
  ...
  else
  {
    ...
    cout << "The arguments are as follows: dt, t_max, g, r, a_start, a_end, div, dP, w1, w2, init_GP, PREFIX.\n";
    exit(1);
  }
