...
void set_Prefix(string& user_prefix, double mG /** = 0.0 */, double mP /** = 0.0 */)
{
	...
	mG_str << setprecision(2) << std::defaultfloat << mG; mP_str << setprecision(2) << std::defaultfloat << mP;
	string SpB_str ="";
	...
	frame_folder = "../Data/Rietkerk/Frames/"+ SpB_str +"/" + prefix + "_";  //Folder to store frames.
	prelim_folder  = "../Data/Rietkerk/Prelims/"+ SpB_str +"/"+ prefix +"_"; //Folder to store preliminary data.
	stat_prefix =  "../Data/Rietkerk/1stOrderCC_Rietkerk_" + prefix + "_P_c_G_"; //Header for frame files.
}
